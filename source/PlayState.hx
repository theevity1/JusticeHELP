...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
			...
			case 'dessert':
				{
					...
					var BG:FlxSprite = new FlxSprite(-1270, -800).loadGraphic(Paths.image('justice/dessert/BG'));
						BG.antialiasing = true;
					...
					var clouds:FlxSprite = new FlxSprite(-1270, -800).loadGraphic(Paths.image('justice/dessert/clouds'));
					...
					var back:FlxSprite = new FlxSprite(-1270, -800).loadGraphic(Paths.image('justice/dessert/back'));
					...
					var floor:FlxSprite = new FlxSprite(-1270, -800).loadGraphic(Paths.image('justice/dessert/floor'));
					...
					var things:FlxSprite = new FlxSprite(-1270, -800).loadGraphic(Paths.image('justice/dessert/things'));
		...
		if (FlxG.save.data.characterSelected != null)
            boyfriend = new Boyfriend(770, 450, FlxG.save.data.characterSelected);
        else
